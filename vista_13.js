function vista_13(username,password){
  ...
  while(!closesesion)
  {
    ...
    function cargar(){
      ...
      //display.tablaUsuarios.clear()
       display.solicitudes_grid_3.clear()
      for (var i = 0; i < response.solicitudes.length; i++) {
        console.log("for ciclo")
        display.solicitudes_grid_3.addRecords([{
    ...
    if (currentRecord != 0){
      ...
      registroSel = display.solicitudes_grid_3.getRecord(currentRecord)
   ...
   // fin monitoreo botones enviar - rechazar
        display.vista_13.execute();
  }

}

exports.run = vista_13;